...
#endif
#if 0
#define CE_SHARP_EXAMPLE1
#define CE_SHARP_EXAMPLE2
#define CE_SHARP_EXAMPLE3
#define CE_SHARP_EXAMPLE4
#endif
...
#endif
#if defined(GAMMA_SHARP_24)
static char gamma_a[25] = {
		0xC7, 0x05, 0x10, 0x17, 0x23, 0x33, 0x4D, 0x41, 0x4F, 0x5C, 0x66, 0x6D, 0x77,
		0x02, 0x0D, 0x15, 0x20, 0x2E, 0x44, 0x39, 0x4F, 0x5B, 0x65, 0x6C, 0x76
		};
static char gamma_b[25] = {
		0xC8, 0x05, 0x10, 0x17, 0x23, 0x33, 0x4D, 0x41, 0x4F, 0x5C, 0x66, 0x6D, 0x77,
		0x02, 0x0D, 0x15, 0x20, 0x2E, 0x44, 0x39, 0x4F, 0x5B, 0x65, 0x6C, 0x76
		};
static char gamma_c[25] = {
		0xC9, 0x05, 0x10, 0x17, 0x23, 0x33, 0x4D, 0x41, 0x4F, 0x5C, 0x66, 0x6D, 0x77,
		0x02, 0x0D, 0x15, 0x20, 0x2E, 0x44, 0x39, 0x4F, 0x5B, 0x65, 0x6C, 0x76
		};
#endif
...
static char test[26] = 	{0xB8, 0x18, 0x80, 0x18, 0x18, 0xCF, 0x04, 0x00,
...
static char test[26] = 	{0xB8, 0x18, 0x80, 0x18, 0x18, 0xCF, 0x1F, 0x00,
...
#endif
#else
static char write_ce_off[2] = {0xCA, 0x00};	/*DTYPE_GEN_WRITE2*/
#endif
...
/*[11] cabc*/
//static char write_cabc_off[2] = {0x55, 0x00};				/* DTYPE_DCS_WRITE1 */
//static char write_cabc_ui[2] = {0x55, 0x01};				/* DTYPE_DCS_WRITE1 */
//static char write_cabc_still[2] = {0x55, 0x02};				/* DTYPE_DCS_WRITE1 */
//static char write_cabc_video[2] = {0x55, 0x03};				/* DTYPE_DCS_WRITE1 */
...
#if defined(GAMMA_SHARP_24)
	{DTYPE_GEN_LWRITE, 1, 0, 0, RENESAS_NO_DELAY,
		sizeof(gamma_a), gamma_a },
	{DTYPE_GEN_LWRITE, 1, 0, 0, RENESAS_NO_DELAY,
		sizeof(gamma_b), gamma_b },
	{DTYPE_GEN_LWRITE, 1, 0, 0, RENESAS_NO_DELAY,
		sizeof(gamma_c), gamma_c },
#endif
#if defined(CONFIG_FB_MSM_MIPI_DSI_CABC)
	{DTYPE_GEN_LWRITE, 1, 0, 0, RENESAS_NO_DELAY,
		sizeof(test), test },
