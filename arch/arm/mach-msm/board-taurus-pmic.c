...
/* Initial PM8921 GPIO configurations for taurus */
static struct pm8xxx_gpio_init pm8921_taurus_gpios[] __initdata = {
	PM8XXX_GPIO_OUTPUT(7, 0),			 /* NFC EXT EN*/
	PM8XXX_GPIO_INPUT(16, PM_GPIO_PULL_UP_30), 	/* SD_CARD_WP */
	PM8XXX_GPIO_OUTPUT(18,	0),	/* TABLA SPKR_LEFT_EN=off */
	PM8XXX_GPIO_OUTPUT(19,	0),	/* MHL 3P3 VCC EN */
	PM8XXX_GPIO_OUTPUT(20, 0),		/* HAPTIC_LEN */
	PM8XXX_GPIO_OUTPUT(21, 0),		/* HDMI 1V8 3V3 EN */
	PM8XXX_GPIO_OUTPUT(22, 1),		/* BACKLIGHT EN */
	PM8XXX_GPIO_OUTPUT(23, 0),		/* VLTG SEL */
	PM8XXX_GPIO_OUTPUT_FUNC(24, 0, PM_GPIO_FUNC_2),	 /* BACKLIGHT  PWM*/
	PM8XXX_GPIO_OUTPUT_FUNC(25, 0, PM_GPIO_FUNC_2),	 /* HAPTIC */
	PM8XXX_GPIO_OUTPUT(32, 0),			/* FLASH_CNTL_EN */
	PM8XXX_GPIO_OUTPUT(33, 0),			/* HAPTIC_HEN */
	PM8XXX_GPIO_OUTPUT_STRENGTH(34, 1, PM_GPIO_STRENGTH_MED),
	PM8XXX_GPIO_OUTPUT(35, 0),			/* EXT BUCK EN */
	PM8XXX_GPIO_OUTPUT(37, 0),			/* LINE IN DET EN */
	PM8XXX_GPIO_OUTPUT(42, 0),                      /* USB 5V reg enable */
	PM8XXX_GPIO_OUTPUT(43, 1),                       /* DISP_RESET_N */
};


/* Initial PM8921 MPP configurations for taurus */
static struct pm8xxx_mpp_init pm8921_taurus_mpps[] __initdata = {
	/* External 5V regulator enable; shared by HDMI and USB_OTG switches. */
	PM8XXX_MPP_INIT(7, D_OUTPUT, PM8921_MPP_DIG_LEVEL_S4, DOUT_CTRL_LOW),
};

/* Initial PM8921 GPIO configurations */
static struct pm8xxx_gpio_init pm8921_gpios[] __initdata = {
	PM8XXX_GPIO_OUTPUT_VIN(6, 1, PM_GPIO_VIN_VPH),	 /* MHL power EN_N */
	PM8XXX_GPIO_OUTPUT(7, 0),			/* PN544 NFC VEN*/
	PM8XXX_GPIO_INPUT(16,	    PM_GPIO_PULL_UP_30), /* SD_CARD_WP */
	...
	PM8XXX_GPIO_OUTPUT(22, 0),		/* BACKLIGHT EN */
	PM8XXX_GPIO_OUTPUT_FUNC(24, 0, PM_GPIO_FUNC_2),	 /* BACKLIGHT  PWM*/
	PM8XXX_GPIO_OUTPUT_FUNC(25, 0, PM_GPIO_FUNC_2),	 /* HAPTIC */
...
void __init msm8960_pm8921_gpio_mpp_init(void)
{
	...
	if (machine_is_msm8960_cdp()) {
		for (i = 0; i < ARRAY_SIZE(pm8921_taurus_gpios); i++) {
			rc = pm8xxx_gpio_config(pm8921_taurus_gpios[i].gpio,
						&pm8921_taurus_gpios[i].config);
			if (rc) {
		...
		for (i = 0; i < ARRAY_SIZE(pm8921_taurus_mpps); i++) {
			rc = pm8xxx_mpp_config(pm8921_taurus_mpps[i].mpp,
						&pm8921_taurus_mpps[i].config);
			if (rc) {
...
void __init msm8960_init_pmic(void)
{
	...
	if (machine_is_msm8960_liquid()) {
		...
		/* Set it to false */
		pm8921_chg_pdata.has_dc_supply = false;
	}
