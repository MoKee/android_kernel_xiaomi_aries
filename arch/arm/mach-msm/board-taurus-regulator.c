...
msm_rpm_regulator_init_data[] __devinitdata = {
	...
	/* FIXME:
	 * Based on MPU-6050 spec, L9_2P85 should be enabled earlier than
	 * LVS4_1P8. So set L9 to always_on to enable it during initialization
	 * as LVS4 is shared between touch IC and sensors on M2A platform.
	 * There is little impact on the bottom current based on the lab test.
	 */
